...
namespace AssessmentProject.Application.Test.DiscountTest
{
    ...
    public class LongTimeDiscountUnitTest
    {
        private readonly DataContext _context;
        private readonly UserRepository _userRepository;
        private readonly InvoiceRepository _invoiceRepository;
        private readonly StoreRepository _storeRepository;
        public LongTimeDiscountUnitTest(DataContext context, UserRepository userRepository, InvoiceRepository invoiceRepository, StoreRepository storeRepository)
        {
            _context = context;
        ...
        [Test]
        public void EmployeeDiscount_ShouldReturnFalse()
        {
            ...
            var isApplicable = longTimeDiscount.IsApplicable(invoice);
            if (isApplicable)
            {
                Assert.Fail();
            }
